...
from plone.app.users.interfaces import IPrincipalTerm
...
class TestSource(ptc.PloneTestCase):
    ...
    def afterSetUp(self):
        ...
        principals_factory = getUtility(IVocabularyFactory, name=u"plone.app.users.Principals")
        self.principals = principals_factory(self.portal)

        users_factory = getUtility(IVocabularyFactory, name=u"plone.app.users.Users")
        self.users = users_factory(self.portal)

        groups_factory = getUtility(IVocabularyFactory, name=u"plone.app.users.Groups")
    ...
    def test_len(self):
        ...
        # Three test groups + Administrators, Reviewers, AuthenticatedUsers
        # and Site Administrators
        self.assertEquals(7, len(self.groups))

        # Both of the above
        self.assertEquals(11, len(self.principals))
